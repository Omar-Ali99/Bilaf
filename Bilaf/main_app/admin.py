...
class Product_Admin(admin.ModelAdmin):
    list_display = ('id', "store", "name","category","price","quantity","is_active","description","image")

class Categories_Admin(admin.ModelAdmin):
    list_display = ('id', "store", "name","logo")

class Cart_Admin(admin.ModelAdmin):
    list_display = ('id', "store", "customer", "status", "created_at", "due_date", "delivery_option", "payment_option")
